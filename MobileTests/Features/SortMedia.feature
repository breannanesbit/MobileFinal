...
Scenario: Media Goes where it should
	Given a latest media list with the following items:
		...
		| 1  | video1   | 1      | 2023-04-20T10:30:00.000Z | Video    | null  | 1          | Videos   |
		| 2  | audio1   | 2      | 2023-04-21T14:00:00.000Z | Audio    | null  | 2          | Audios   |
		| 3  | picture1 | 1      | 2023-04-22T16:45:00.000Z | Visual   | null  | 3          | Pictures |
	...
	Then the video list should contain the following items:
		| Id | MediaKey                                                       | UserId | DateUpload               | FileName | Likes | CategoryId | Category |
		| 1  | https://mobilemediastorage.blob.core.windows.net/videos/video1 | 1      | 2023-04-20T10:30:00.000Z | Video    | null  | 1          | Videos   |
	And the audio list should contain the following items:
		| Id | MediaKey                                                       | UserId | DateUpload               | FileName | Likes | CategoryId | Category |
		| 2  | https://mobilemediastorage.blob.core.windows.net/audios/audio1 | 2      | 2023-04-21T14:00:00.000Z | Audio    | null  | 2          | Audios   |
	And the visual list should contain the following items:
		| Id | MediaKey                                                           | UserId | DateUpload               | FileName | Likes | CategoryId | Category |
		| 3  | https://mobilemediastorage.blob.core.windows.net/pictures/picture1 | 1      | 2023-04-22T16:45:00.000Z | Visual   | null  | 3          | Pictures |
